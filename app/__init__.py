...
app.register_blueprint(body_routes, url_prefix='/api/bodies')
app.register_blueprint(daily_routes, url_prefix='/api/dailies')
app.register_blueprint(face_routes, url_prefix='/api/faces')
app.register_blueprint(habit_routes, url_prefix='/api/habits')
app.register_blueprint(hair_routes, url_prefix='/api/hairs')
app.register_blueprint(to_do_routes, url_prefix='/api/to_dos')
db.init_app(app)
Migrate(app, db)
